...
Snake.prototype.update = function(keyCode){
  if (keyCode === 38 && this.direction !== 2) { this.direction = 1;}
  if (keyCode === 40 && this.direction !== 1) { this.direction = 2;}
  if (keyCode === 37 && this.direction !== 4) { this.direction = 3;}
  if (keyCode === 39 && this.direction !== 3) { this.direction = 4;}
};
